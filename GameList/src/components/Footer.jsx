...
function GitHubIcon() {
  ...
  return (
     <footer className="border-t border-[#333333] py-12 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2">
              <ControllerIcon />
              <span className="text-lg font-bold tracking-tight text-white">GameList</span>
            </div>
            <p className="text-sm text-slate-400">
              © 2024 GameList. Engineered for enthusiasts worldwide.
            </p>
            <a
